...
export class CareerHistory {
  items = [
    ...
    {title: "Lycée Albert Londres – Vichy", date: "2020 - 2023", text: "Baccalauréat général – Mention Très Bien, spécialité Mathématiques et NSI, option Mathématiques expertes."},
